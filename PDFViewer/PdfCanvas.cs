...
public class PdfCanvas:ICustomDrawOperation
{
    ...
    public void Render(IDrawingContextImpl context)
    {
        ...
        foreach (var page in Pages)
        {
            ...
            canvas.DrawImage(page.Image, new SKPoint());
    ...
    private static readonly SKPaint BlankPagePaint = new SKPaint
    {
        Color = SKColors.White
    };
    
    private static readonly SKPaint BlankPageShadowPaint = new SKPaint
    {
