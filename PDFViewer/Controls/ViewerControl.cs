...
namespace PDFViewer.Controls;

public class ViewerControl: Control
    {
        private PdfCanvas InteractiveCanvas { get; set; } = new ();
        
        public static readonly StyledProperty<ObservableCollection<PreviewPage>> PagesProperty =
            AvaloniaProperty.Register<ViewerControl, ObservableCollection<PreviewPage>>(nameof(Pages));
        ...
        public static readonly StyledProperty<float> CurrentScrollProperty = AvaloniaProperty.Register<ViewerControl, float>(nameof(CurrentScroll));
        ...
        public static readonly StyledProperty<float> ScrollViewportSizeProperty = AvaloniaProperty.Register<ViewerControl, float>(nameof(ScrollViewportSize));
